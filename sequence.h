...
#ifndef MAIN_SAVITCH_SEQUENCE_H     // MACRO GUARD start
...
namespace main_savitch_4
{
    ...
    public:
        ...
        value_type current_i( ) const;
        value_type current_cap( ) const;

    private:    
        // cannot touch these (this) outside class scope
        value_type* data;   // ptr
        size_type used;
